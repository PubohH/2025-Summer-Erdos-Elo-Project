...
For the scraped data, since matches dates are available for almost all matches, we sort the matches by tournament start time and stages. Details can be [found in data_clearning3](/1_Match_Data/Scraped%20Data/data_cleaning3.ipynb).
...
Notice:   
1. 2/3 of matches don't have date information and they concentrate in early years. For the matches with date information, they are in the correct order. 