...
We predicted the match results for the 750th, 800th and 1080th tournament, each happened in 2013, 2014 and 2025. We run each prediction five times. The average accuracy scores are 0.511, 0.544 and 0.476. The prediction for the 1080th tournament is inconsistent for the reason that rankings information after 2019 is missing and random number generator is used in this model. For more details, see [baseline1.ipynb](/Baseline/baseline1/baseline1.ipynb).
